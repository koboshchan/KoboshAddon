...
@SearchTags({"player esp 2", "playeresp2", "PlayerTracers2", "player tracers 2"})
public final class PlayerESP2Hack extends Hack implements UpdateListener,
	CameraTransformViewBobbingListener, RenderListener
{
	...
	private final CheckboxSetting ignoreFriends = new CheckboxSetting(
		"Ignore friends", "Won't show players on your friends list.", true);
